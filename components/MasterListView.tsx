...
const MasterListView: React.FC<Props> = ({ currentLanguage, isSidebarOpen }) => {
  ...
  const handleSaveDescriptionModal = () => {
    handleEdit(descriptionModal.itemId, descriptionModal.field, descriptionModal.content);
                ...
                paginatedData.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                      ...
                      {/* Description */}
                      {visibleColumns.description && <td className="p-1">
                      ...
                      {visibleColumns.rexScFob && <td className="p-1"><FormattedNumberInput value={display.rexScFob} onChange={(val) => handleEdit(item.id, 'rexScFob', val)} disabled={isReadOnly} className="w-full bg-transparent p-2 rounded border border-transparent hover:border-gray-200 dark:hover:border-slate-600 focus:border-primary-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-none transition-all text-right text-slate-800 dark:text-slate-200 text-sm disabled:cursor-not-allowed disabled:opacity-60" /></td>}
                      {visibleColumns.forex && <td className="p-1"><FormattedNumberInput value={display.forex} onChange={(val) => handleEdit(item.id, 'forex', val)} disabled={isReadOnly} className="w-full bg-transparent p-2 rounded border border-transparent hover:border-gray-200 dark:hover:border-slate-600 focus:border-primary-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-none transition-all text-right text-slate-800 dark:text-slate-200 text-sm disabled:cursor-not-allowed disabled:opacity-60" /></td>}
                      {visibleColumns.sst && <td className="p-1"><FormattedNumberInput value={display.sst} onChange={(val) => handleEdit(item.id, 'sst', val)} disabled={isReadOnly} className="w-full bg-transparent p-2 rounded border border-transparent hover:border-gray-200 dark:hover:border-slate-600 focus:border-primary-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-none transition-all text-right text-slate-800 dark:text-slate-200 text-sm disabled:cursor-not-allowed disabled:opacity-60" /></td>}
                      {visibleColumns.opta && <td className="p-1"><FormattedNumberInput value={display.opta} onChange={(val) => handleEdit(item.id, 'opta', val)} disabled={isReadOnly} className="w-full bg-transparent p-2 rounded border border-transparent hover:border-gray-200 dark:hover:border-slate-600 focus:border-primary-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-none transition-all text-right text-slate-800 dark:text-slate-200 text-sm disabled:cursor-not-allowed disabled:opacity-60" /></td>}
